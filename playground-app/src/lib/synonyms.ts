...
const PROXY_ROWS: Array<[string, string, string]> = [
  ...
  ['d13C', 'd13C', 'isotopic'], ['d13Cwax', 'd13C', 'isotopic'],
  ['d15N', 'd15N', 'isotopic'],
  ['cellulose d18O', 'd18O', 'isotopic'], ['d18O', 'd18O', 'isotopic'], ['delta18O', 'd18O', 'isotopic'], ['foram d18O', 'd18O', 'isotopic'],
  ['d2H', 'dD', 'isotopic'], ['dD', 'dD', 'isotopic'], ['dDwax', 'dD', 'isotopic'], ['leaf wax', 'dD', 'isotopic'], ['leafWax', 'dD', 'isotopic'],
