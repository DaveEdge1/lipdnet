  ...
  useEffect(() => {
    ...
    import('plotly.js-dist-min').then((mod) => {
      ...
      Plotly.react(divRef.current, [{
        ...
        type: 'scatter',
        mode: 'lines+markers',
        marker: { size: 4, color: '#71a436' },
        line: { color: '#71a436', width: 1.5 },
        name: dataCol.variableName,
        connectgaps: false,
      }], {
        autosize: true,
        margin: { l: 70, r: 20, t: 30, b: 60 },
        xaxis: { title: { text: xLabel }, autorange: true, gridcolor: '#e4e4e4', color: '#656565' },
        yaxis: { title: { text: yLabel }, gridcolor: '#e4e4e4', color: '#656565' },
        paper_bgcolor: 'transparent',
        plot_bgcolor: '#ffffff',
        font: { color: '#656565', size: 12 },
      }, {
        displaylogo: false,
        responsive: true,
      })
