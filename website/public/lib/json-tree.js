...
(function(){
    ...
    angular.module('json-tree', [])
                    ...
                    '<li ng-repeat="key in utils.keys(json) track by key">' +
                        '<div draggable-tree>' +
                            ...
                            '<span ng-hide="childs[key].isObject()">' +
                                ...
                                '<input ng-if="childs[key].type() === \'number\'" type="number" step="any" ng-model="json[key]"/>' +
                                // '<input ng-if="childs[key].type() === \'number\'" type="text" ng-model="json[key]" ng-change="utils.validateNode(key)" placeholder="null"/>' +
        ...
        .directive('draggableTree', ['$document', function($document) {
            return {
